...
<head>
    <meta charset="utf-8">
    <title>Welcome to SIFIN Investment Limited</title>
    <!-- Stylesheets -->
...
<body class="home header-transparent  header-sticky header-v1 hide-topbar-mobile">
    <div id="page">
                        ...
                        <div class="office-location clearfix">
                           <!-- <div class="office-switcher"><i class="flaticon-globe "></i>
                            ...
                            <ul class="topbar-office active">
                                <li><i class="flaticon-telephone" aria-hidden="true"></i>Phone  +233 (0) 302  261 903</li>
                                <li><i class="flaticon-web" aria-hidden="true"></i>info@sifinghana.com</li>
                                <li><i class="flaticon-pin" aria-hidden="true"></i>Apenkwa Park (Adjacent Shianor JHS)</li>
                            </ul>
                    ...
                    <div class="row">
                        <div class="site-logo col-md-3 col-sm-6 col-xs-6">
                            <a href="index-2.html" class="logo">
                                <img src="images/logo-light.png" alt="CargoHub" class="logo-light show-logo">
                                <img src="images/logo.png" alt="CargoHub" class="logo-dark hide-logo">
                            </a>
                            <h1 class="site-title"><a href="#">Welcome to SIFIN GHANA</a></h1>
                            <h2 class="site-description">Just another Steel Themes Sites site</h2>
                        </div>
                        <div class="site-menu col-md-9 col-sm-6 col-xs-6">
                            <nav id="site-navigation" class="main-nav primary-nav nav">
                                <ul class="menu">
                                    <li class=""><a href="index.php" class="dropdown-toggle">Home</a>
                                        <!--<ul class="sub-menu">
                                     ...
                                     <li class="has-children"><a href="#" class="dropdown-toggle">About Us</a>
                                        <ul class="sub-menu">
                                            <li><a href="about-us.html">Coperate Profile</a></li>
        ...
        <div class="welcomesec secpadd">
            <div class="container">
                <div class="fh-section-title clearfix  text-center version-dark paddbtm20">
                    <h2>Welcome to SIFIN <span class="main-color">Investment LTD</span></h2>
                </div>
                <p class="haeadingpara text-center paddbtm40"> At SIFIN,  we strive to make a genuine diﬀerence in the lives of our clients, an attitude that inspires the way we work together. <br/>Many of our corporate and individual customers have grown to trust our proven ability to deliver relevant and eﬃcient services to solve their short and long term ﬁnancial needs.
                     </p>
                ...
                <div class="welservices row">
                    <div class="col-md-4 col-sm-6">
                        <div class="fh-icon-box icon-type-theme_icon style-1 version-dark hide-button icon-left">
                            ...
                            <h4 class="box-title"><a href="#">Lending to Importers</a></h4>
                            <div class="desc">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="fh-icon-box icon-type-theme_icon style-1 version-dark hide-button icon-left">
                            ...
                            <h4 class="box-title"><a href="#">Collateral Management </a></h4>
                            <div class="desc">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="fh-icon-box icon-type-theme_icon style-1 version-dark hide-button icon-left">
                            ...
                            <h4 class="box-title"><a href="#">Auto Leasing</a></h4>
                            <div class="desc">
        ...
        <section class="homecounts">
            <div class="container">
                <h2 class="count-title">At SINFIN <span class="main-color">Investment LTD</span> We Provide Solutions that matches your business</h2>
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-lg-offset-2">
                        <div class="fh-counter icon-type-none">
                            <div class="counter">
                                <div class="value">9800</div>
                                <h4>Lending to Importers</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6  secpaddlf">
                        <div class="fh-section-title clearfix  text-left version-dark paddbtm40">
                            <h2>SIFIN CORE VALUES</h2>
                        </div>
                        <div class="fh-icon-box  style-2 icon-left has-line">
                            <span class="fh-icon"><i class="flaticon-global-1"></i></span>
                            <h4 class="box-title"><span>The GOD Factor</span></h4>
                            <div class="desc">
                                <p>The author and ﬁnisher of our faith. The source of our inspiration.</p>
                            </div>
                        </div>
                        <div class="fh-icon-box  style-2 icon-left has-line">
                            <span class="fh-icon"><i class="flaticon-people"></i></span>
                            <h4 class="box-title"><span>Honesty and Integrity</span></h4>
                            <div class="desc">
                                <p>We expect nothing less from one another and commit to a completely honest relationship with our clients in which, we behave with the utmost integrity to protect you, the security and your privacy</p>
                            </div>
                        </div>
                        <div class="fh-icon-box  style-2 icon-left has-line">
                            <span class="fh-icon"><i class="flaticon-route"></i></span>
                            <h4 class="box-title"><span>Mutual Respect </span></h4>
                            <div class="desc">
                                <p>Operating in an environment of mutual respect sets the tone for how well we can work together</p>
                            </div>
                        </div>
                        <div class="fh-icon-box  style-2 icon-left">
                            <span class="fh-icon"><i class="flaticon-people-1"></i></span>
                            <h4 class="box-title"><span>Teamwork </span></h4>
                            <div class="desc">
                                <p>We recognize that we need one another to meet the needs of our clients. Our teams work across business units to make sure our clients get the best possible service and product solution</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="fh-form-1 fh-form">
                                <div class="row fh-form-row">
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
                                            <input name="delivery-city" value="" placeholder="First Name*" type="text">
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
                                            <input name="distance" value="" placeholder="Last Name*" type="text">
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
                                            <input name="weight" value="" placeholder="Telephone*" type="text">
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <p class="field">
                                            <input name="your-name" value="" placeholder="E-mai Address*" type="text">
                                        </p>
                                    </div>
                    ...
                    <div class="list-item slide-partener">
                        <div class="partner-item">
                            <div class="partner-content">
                                <a href="#" target="_self"><img alt="1764" src="images/partener/partner-4.png"></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="partner-content">
                                <a href="#" target="_self"><img alt="1763" src="images/partener/partner-3.png"></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="partner-content">
                                <a href="#" target="_self"><img alt="1762" src="images/partener/partner-2.png"></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="partner-content">
                                <a href="#" target="_self"><img alt="1761" src="images/partener/partner.png"></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="partner-content">
                                <a href="#" target="_self"><img alt="1765" src="images/partener/Fertilizers.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="post-list  news-slide">
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="images/blogs/blog-1.jpg" alt="" /></a>
                        ...
                        <div class="item-latest-post clearfix">
                            ...
                            <div class="entry-summary">
                                <div class="entry-meta clearfix">
                                    <span class="meta author">by <a href="#">steelthemes</a></span>
                                    <span class="meta cat-links"><a href="#">Logistic</a>, <a href="#">Warehousing</a></span>
                                </div>
                        ...
                        <div class="item-latest-post clearfix">
                            ...
                            <div class="entry-summary">
                                <div class="entry-meta clearfix">
                                    <span class="meta author">by <a href="#">steelthemes</a></span>
                                    <span class="meta cat-links"><a href="#">High Way</a>, <a href="#">Warehousing</a></span>
                                </div>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="images/blogs/blog-5.jpg" alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">26</span>
                                    <span class="month">Jul</span>
                                </div>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="images/blogs/blog-6.jpg" alt="" /></a>
                                <div class="entry-time">
                            ...
                            <div class="entry-summary">
                                <div class="entry-meta clearfix">
                                    <span class="meta author">by <a href="#">steelthemes</a></span>
                                    <span class="meta cat-links"><a href="#">Entrepreneurs</a>, <a href="#">Warehousing</a></span>
                                </div>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="images/blogs/blog-7.jpg" alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">09</span>
                                    <span class="month">Aug</span>
                                </div>
                            ...
                            <div class="entry-summary">
                                <div class="entry-meta clearfix">
                                    <span class="meta author">by <a href="#">steelthemes</a></span>
                                    <span class="meta cat-links"><a href="#">Logistic</a>, <a href="#">Pharmacology</a></span>
                                </div>
                        ...
                        <div class="item-latest-post clearfix">
                            <div class="entry-thumbnail">
                                <a href="#"><img src="images/blogs/blog-8.jpg" alt="" /></a>
                                <div class="entry-time">
                                    <span class="day">09</span>
                                    <span class="month">Aug</span>
                                </div>
                            ...
                            <div class="entry-summary">
                                <div class="entry-meta clearfix">
                                    <span class="meta author">by <a href="#">steelthemes</a></span>
                                    <span class="meta cat-links"><a href="#">Manufacturing</a>, <a href="#">Warehousing</a></span>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-signs"></i>
                           <p>Address : P. O. Box CT, 4491 Cantonment, Accra-Ghana</p>
                            <h4>Location: Apenkwa Park (Adjacent Shianor JHS)</h4>
                        </div>
                        <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-phone-call"></i>
                            <p>Telephone: </p>
                            <h4>+233 (0) 302  261 903  +233 (0) 243 222 768</h4></div>
                        <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-web"></i>
                            <p>E-mail us : </p>
                            <h4>info@sifinghana.com sales@sifinghana.com</h4></div>
                        <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-clock-1"></i>
                            <p>Opening Hours :</p>
                            <h4>MON – FRI: 8AM – 5PM</h4>
                            <h4>SAT – SUN: Closed</h4></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="footer-sidebar footer-1 col-xs-12 col-sm-6 col-md-3">
                            <div class="widget widget_text">
                                ...
                                <div class="textwidget">
                                    <p>Cargo HUB Logistics Services is a global supplier of transport and logistics solutions. We have offices in more than 20 countries and an international network of partners and agents.</p>
                                </div>
                            </div>
                            <div class="widget cargohub-social-links-widget">
                                <div class="list-social style-1">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-copyright col-md-6 col-sm-12 col-sx-12">
                        <div class="site-info">Copyright &copy; <?php echo gmdate('Y');?> All Right Reserved. <a href="#">Powered by FOKAS TECHNOLOGIES</a> </div>
                    </div>
...
<!-- Mirrored from steelthemes.com/demo/html/cargohub_theme/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Jul 2018 14:33:24 GMT -->
</html>